# Generated by Django 6.1 on 2026-08-07 08:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('RECRUITER', 'Recruiter'), ('CANDIDATE', 'Candidate')], default='CANDIDATE', max_length=20, verbose_name='User Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_type', models.CharField(choices=[('REGISTRATION', 'Registration'), ('FORGOT_PASSWORD', 'Forgot Password')], max_length=30, verbose_name='OTP Type')),
